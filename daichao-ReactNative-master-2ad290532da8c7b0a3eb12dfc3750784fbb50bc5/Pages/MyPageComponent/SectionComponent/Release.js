                ...
                <View style={{backgroundColor: 'white'}}>
                    ...
                    <View style={styles.textInputStyle}>
                        <View style={{flex: 1, flexDirection: 'row'}}>
                            {
                                this.state.imgName === null ? <View/> :
                                    <Image style={styles.headPhoto} source={this.state.imgName}/>
                            }
                            <TouchableOpacity style={styles.headPhotoStyle} activeOpacity={1}
                                              onPress={() => this.openMyCamera()}>
                                <Text style={styles.imgText}>{this.state.isAdd ? "修改照片" : "添加照片"}</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                </View>
